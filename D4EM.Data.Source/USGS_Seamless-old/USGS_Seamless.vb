...
Public Class USGS_Seamless
    ...
    'Updated kw: 5/26/2015
    'The IdFieldName contains the string used in the new web service call    
    Public Class LayerSpecifications
        Public Class NLCD1992
            Public Shared LandCover As New LayerSpecification(Name:="NLCD 1992 Land Cover", Tag:="NLCD1992", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="landcover_1992_conus")
        End Class
        Public Class NLCD2001
            Public Shared LandCover As New LayerSpecification(Name:="NLCD 2001 Land Cover", Tag:="NLCD2001.LandCover", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="landcover_2001_conus")
            Public Shared Canopy As New LayerSpecification(Name:="NLCD 2001 Canopy", Tag:="NLCD2001.Canopy", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="canopy_2001_conus")
            Public Shared Impervious As New LayerSpecification(Name:="NLCD 2001 Impervious", Tag:="NLCD2001.Impervious", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="impervious_2001_conus")
            'Data for Alaska
            Public Shared LandCoverAK As New LayerSpecification(Name:="NLCD 2001 Land Cover AK", Tag:="NLCD2001.LandCoverAK", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="landcover_2001_ak")
            Public Shared CanopyAK As New LayerSpecification(Name:="NLCD 2001 Canopy AK", Tag:="NLCD2001.CanopyAK", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="canopy_2001_ak")
            Public Shared ImperviousAK As New LayerSpecification(Name:="NLCD 2001 Impervious AK", Tag:="NLCD2001.ImperviousAK", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="impervious_2001_ak")
            'Data for Hawaii
            Public Shared LandCoverHI As New LayerSpecification(Name:="NLCD 2001 Land Cover HI", Tag:="NLCD2001.LandCoverHI", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="landcover_2001_hi")
            Public Shared CanopyHI As New LayerSpecification(Name:="NLCD 2001 Canopy HI", Tag:="NLCD2001.CanopyHI", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="canopy_2001_hi")
            Public Shared ImperviousHI As New LayerSpecification(Name:="NLCD 2001 Impervious HI", Tag:="NLCD2001.ImperviousHI", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="impervious_2001_hi")
            'Data for Puerto Rico
            Public Shared LandCoverPR As New LayerSpecification(Name:="NLCD 2001 Land Cover PR", Tag:="NLCD2001.LandCoverPR", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="landcover_2001_pr")
            Public Shared CanopyPR As New LayerSpecification(Name:="NLCD 2001 Canopy PR", Tag:="NLCD2001.CanopyPR", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="canopy_2001_pr")
            Public Shared ImperviousPR As New LayerSpecification(Name:="NLCD 2001 Impervious PR", Tag:="NLCD2001.ImperviousPR", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="impervious_2001_pr")
        End Class
        Public Class NLCD2006
            Public Shared LandCover As New LayerSpecification(Name:="NLCD 2006 Land Cover", Tag:="NLCD2006.LandCover", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="landcover_2006_conus")
            Public Shared Impervious As New LayerSpecification(Name:="NLCD 2006 Impervious", Tag:="NLCD2006.Impervious", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="impervious_2006_conus")
        End Class
        Public Class NLCD2011
            Public Shared LandCover As New LayerSpecification(Name:="NLCD 2011 Land Cover", Tag:="NLCD2011.LandCover", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="landcover_2011_conus")
            Public Shared Canopy As New LayerSpecification(Name:="NLCD 2011 Canopy", Tag:="NLCD2011.Canopy", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="canopy_2011_conus")
            Public Shared Impervious As New LayerSpecification(Name:="NLCD 2011 Impervious", Tag:="NLCD2011.Impervious", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="impervious_2011_conus")
        End Class
        Public Class NLCDLandChange
            Public Shared LandCoverChange01_06 As New LayerSpecification(Name:="NLCD 2001-2006 Land Cover Change", Tag:="NLCD2011.LandCoverChange", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="lc_change_01_06")
            Public Shared LandCoverChange01_11 As New LayerSpecification(Name:="NLCD 2001-2011 Land Cover Change", Tag:="NLCD2011.LandCoverChange", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="lc_change_01_11")
            Public Shared LandCoverChange06_11 As New LayerSpecification(Name:="NLCD 2006-2011 Land Cover Change", Tag:="NLCD2011.LandCoverChange", Role:=Roles.LandUse, Source:=GetType(USGS_Seamless), IdFieldName:="lc_change_06_11")
        End Class
        'Public Class NED
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Overloads Shared Function Execute2(ByVal aProject As Project,
...
StartOver:
        ...
        Else
            ...
            Select Case aDataType
                ...
                Case LayerSpecifications.NLCD2001.LandCoverAK
                    lDataType = "landcover"
                    lBaseFilename = "NLCD_AK_" & lDataType & "_2001"
                Case LayerSpecifications.NLCD2001.CanopyAK
                    lBaseFilename = "NLCD_AK_" & lDataType & "_2001"
                Case LayerSpecifications.NLCD2001.ImperviousAK
                    lDataType = "impervious"
                    lBaseFilename = "NLCD_AK_" & lDataType & "_2001"

                Case LayerSpecifications.NLCD2001.LandCoverHI
                    lDataType = "landcover"
                    lBaseFilename = "NLCD_HI_" & lDataType & "_2001"
                Case LayerSpecifications.NLCD2001.CanopyHI
                    lBaseFilename = "NLCD_HI_" & lDataType & "_2001"
                Case LayerSpecifications.NLCD2001.ImperviousHI
                    lDataType = "impervious"
                    lBaseFilename = "NLCD_HI_" & lDataType & "_2001"

                Case LayerSpecifications.NLCD2001.LandCoverPR
                    lDataType = "landcover"
                    lBaseFilename = "NLCD_PR_" & lDataType & "_2001"
                Case LayerSpecifications.NLCD2001.CanopyPR
                    lBaseFilename = "NLCD_PR_" & lDataType & "_2001"
                Case LayerSpecifications.NLCD2001.ImperviousPR
                    lDataType = "impervious"
                    lBaseFilename = "NLCD_PR_" & lDataType & "_2001"
                ...
                Case LayerSpecifications.NLCD2011.Canopy
                    lBaseFilename = "NLCD_" & lDataType & "_2011"
            ...
            Dim lFinalLayerName As String = IO.Path.Combine(lSaveIn, lBaseFilename & ".tiff")
            ...
            Else
                Dim URL As String = BuildURL2(aDataType, lNorth, lSouth, lWest, lEast)
                ...
                Using respStream As Stream = response.GetResponseStream()
                    Using fileStream As Stream = File.OpenWrite(lFinalLayerName)
                        respStream.CopyTo(respStream)
                    End Using
                End Using
            End If
    ...
    Private Shared Function BuildURL2(ByVal aLayerSpecification As LayerSpecification, _
                                     ByVal aNorth As Double, _
                                     ByVal aSouth As Double, _
                                     ByVal aWest As Double, _
                                     ByVal aEast As Double) As String

        Dim baseURL As String = "http://landfire.cr.usgs.gov/arcgis/rest/services/NLCD/USGS_EDC_LandCover_NLCD/ImageServer/exportImage?" &
                                "bbox={{xmin:+-{0},+ymin:+{1},+xmax:+-{2},+ymax:+{3}}}&bboxSR={4}&size=&imageSR={5}" &
                                "&time=&format=tiff&pixelType=U8&noData=&noDataInterpretation=esriNoDataMatchAny&interpolation=RSP_NearestNeighbor" &
                                "&compression=&compressionQuality=&bandIds=&renderingRule=&f=image"

        Dim params As New List(Of String)
        params.Add(aWest.ToString())
        params.Add(aNorth.ToString())
        params.Add(aEast.ToString())
        params.Add(aSouth.ToString())

        baseURL = String.Format(baseURL, params)

        Dim mosaicRule As String = "&mosaicRule={{""where"":""Name='XXX'""}}"
        mosaicRule = mosaicRule.Replace("XXX", aLayerSpecification.IdFieldName)

        Dim retURL = baseURL + mosaicRule
