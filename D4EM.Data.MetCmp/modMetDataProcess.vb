...
Public Module modMetDataProcess
        ...
        For Each lts In aTsGroup
            ...
            If Not lCons.Contains("-OBS") Then
                Logger.Dbg("MissSummary:Summarizing station DSN " & lts.Attributes.GetValue("ID") & _
                           " - Constituent: " & lCons)
                Try
                    If lts.numValues = 0 OrElse _
                       Double.IsNaN(lts.Dates.Value(0)) OrElse _
    ...
    Public Sub FirstFilter(ByVal aTsGroupInput As atcTimeseriesGroup, ByVal aTsGroupOutput As atcTimeseriesGroup, ByVal aInfoPath As String)
        ...
        Else
            ...
            lSkipped += 1
        End If
        Logger.Dbg("FirstFilter: Saved " & lStaCount & " datasets." & vbCrLf & _
        ...
        For Each lts As atcTimeseries In aTsGroup
            ...
            If lAddMe Then
                If lPctMiss > 0 Then
                        ...
                        If i < pMaxNearStas Then
                            ...
                            With lFillTS.Attributes
                                If .GetValue("Constituent") = lCons Then
                                    ...
                                    Logger.Dbg("FillMissing:  Using " & _
                                               .GetValue("Constituent") & " from " & _
                                               .GetValue("Location") & " " & _
                                               .GetValue("STANAM") & " at Lat/Lng " & _
                    ...
                    End If
                    If lPctMiss > 0 AndAlso (lCons = "ATEMP" OrElse lCons = "DPTEMP" OrElse lCons = "DEWP" OrElse _
