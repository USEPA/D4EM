...
namespace D4EM_NCDC
{
    public class NCDC : Extension
    {
        ...
        private void AddMenuItems(IHeaderControl header)
        {
            ...
            const string SampleMenuKey = "NCDC";

            header.Add(new RootItem(SampleMenuKey, "NCDC"));
            SimpleActionItem alphaItem = new SimpleActionItem(SampleMenuKey, "NCDC", myEventHandler) { Key = "keyNCDC" };
        ...
        private void myEventHandler(object sender, EventArgs e)
        {
            ...
            NCDCBox NCDCbox = new NCDCBox();
            NCDCbox.ShowDialog();

            string fileName;
            string downloadFilePath = @"C:\Temp\DownloadedFilePathNCDC";
            ...
            File.Delete(@"C:\Temp\DownloadedFilePathNCDC");
        }
